...
REQUIRED_PATHS = [
    ...
    "docs/standards/developer-tooling/schemas/golden-path-dependency-observation-v2.schema.json",
...
def validate_schema_sources() -> None:
    ...
    expected_versions = {
        ...
        "golden-path-dependency-observation-v2.schema.json": "golden-path-dependency-observation/v2",
