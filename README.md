...
Org-wide **default community health files** for the `5010-dev` organization.

Files here are inherited by any repository in the org that does **not** provide
its own equivalent. A repository's own file always takes precedence.
