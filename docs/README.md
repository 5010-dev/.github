...
- [Release artifact and version profiles](./standards/release-versioning/profiles.md)
- [Release compatibility lifecycle](./standards/release-versioning/lifecycle.md)
- [Release records and evidence](./standards/release-versioning/release-evidence.md)
- [Release automation](./standards/release-versioning/automation.md)
- [Release adoption and exceptions](./standards/release-versioning/exceptions.md)
